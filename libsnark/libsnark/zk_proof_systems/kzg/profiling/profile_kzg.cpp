/** @file
 *****************************************************************************
 Profiling program that exercises the KZG10 (first generator, then prover,
...
int main(int argc, const char * argv[])
{
    ...
    run_kzg<default_kzg_pp>(example, test_serialization);
    libff::print_header("(leave) Profile R1CS GG-KZG10");
}
