...
#include <libsnark/zk_proof_systems/dario/components/lego/r1cs_gg_ppzksnark_params.hpp>
...
#include <libsnark/zk_proof_systems/dario/components/lego/r1cs_gg_ppzksnark.tcc>
