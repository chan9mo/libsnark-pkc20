...
#include <libsnark/zk_proof_systems/dario/components/lego/examples/run_r1cs_gg_ppzksnark.hpp>
...
void test_r1cs_gg_ppzksnark(size_t num_constraints,
                         size_t input_size)
{
    libff::print_header("(enter) Test Lego CP-SNARK");
    ...
    libff::print_header("(leave) Test Lego CP-SNARK");
}
